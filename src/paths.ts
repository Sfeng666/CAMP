...
import { hostPlatform, type HostPlatform, userHome } from "./platform.js";
...
export function ensurePrivateFile(path: string, mode = 0o600): void {
...
export function ensureCampDirectories(paths = getCampPaths()): CampPaths {
  for (const path of [
    paths.home,
    paths.configDir,
    paths.stateDir,
