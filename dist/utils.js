...
export function toStringContent(value) {
    ...
    if (Array.isArray(value)) {
        return value
            ...
            if (entry && typeof entry === "object") {
                const record = entry;
                return toStringContent(record.text ?? record.content ?? record.input_text ?? record.output_text ?? record.message);
            }
            return "";
        })
            .filter(Boolean)
...
export function truncateByApproxTokens(text, maxTokens) {
