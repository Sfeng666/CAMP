...
export function setupProject(store, path) {
    return store.registerProject(inspectProject(path));
}
export function resolveProject(store, identifier = process.cwd()) {
...
export function writePortableManifest(project) {
...
export function portableProjectId(rootPath) {
